            ...
            <>
              ...
              {loading ? (
                ...
                <div className="grid gap-3 grid-cols-1 md:grid-cols-2 lg:grid-cols-3">
                  {obraCards.map((card) => (
                    <button key={card.obra} onClick={() => setSelectedObra(card.obra)} className="group text-left rounded-lg border border-border bg-card p-4 transition-all hover:border-purple-500/40 hover:bg-purple-950/5 active:scale-[0.98]">
