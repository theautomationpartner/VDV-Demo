...
export const NAV_SECTIONS = [
  {
    ...
    label: "OC Tracker",
    basePath: "/oc-tracker",
    // El Generador de OC vive adentro de esta seccion pero sus pantallas
    // cuelgan de otra ruta: sin esto, estando en /generador-oc la seccion no
    // se marcaba como activa.
    ...
    items: [
      ...
      // El Generador de OC se muestra ACA, pero sigue siendo una app aparte a
      // la hora de los permisos: `app` hace que estos dos items solo aparezcan
      // para quien la tenga asignada. Sin eso, como OC Tracker se le muestra a
      // cualquier sesion valida, el Generador quedaria a la vista de todos.
      // En el Generador todos los roles hacen lo mismo: emitir ordenes. Quien
      // puede aprobar se decide orden por orden, no por rol.
      { label: "Órdenes de Compra", href: "/generador-oc", icon: History, roles: null, app: "generador-oc" },
      { label: "Nueva Orden", href: "/generador-oc?nueva=1", icon: FilePlus2, roles: null, app: "generador-oc" },
    ],
  },
  {
    key: "vale-express",
