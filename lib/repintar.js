...
export function repintarAlVolverElFoco() {
  ...
  const alVolver = () => {
    ...
    // Se insiste unas cuantas veces: el primer cuadro despues de cerrar el
    // dialogo puede seguir mostrando lo viejo, sobre todo si el navegador
    // todavia esta acomodando el alto de la ventana.
    repintarPagina();
    setTimeout(repintarPagina, 150);
    setTimeout(repintarPagina, 500);
  };
