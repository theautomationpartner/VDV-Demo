 ...
 *
 * Habilita ademas ELEGIRSE A SI MISMO como aprobador al emitir. No es un
 * permiso aparte: quien puede aprobar cualquier orden ya podia firmar las
 * suyas, solo que antes tenia que designar a otro primero -y el documento
 * quedaba diciendo que aprobo alguien que nunca la vio, que es la misma familia
 * de problema que este circuito vino a arreglar. Se probo tenerlo como una
 * casilla aparte y se descarto: era una casilla mas para administrar sin dar
 * ningun poder que esta no diera ya.
 */
