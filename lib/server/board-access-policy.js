 ...
 *
 * OJO con lo que esto NO resuelve: sigue sin verificarse que ESE contrato sea
 * del proveedor que lo pide. Eso necesita el filtro por proveedor derivado de
 * la sesion, que hoy no se puede hacer porque el JWT guarda el nombre del
 * proveedor y no su id de item. Esto cierra el paso entre apps, no el de un
 * subcontratista al contrato de otro.
 */
export function verificarAccesoArchivo(sesion, boardKey) {
  if (boardKey !== "FlujoContratacionSubcontratoBoard") {
